...
class GetModeStatsUseCase:
    ...
    async def execute(self, user_id: int, cycle_id: int | None = None) -> ModeAppDTO:
        a_mode = await self.user_stats_repo.count_applications_grouped_by_mode(user_id, cycle_id)
