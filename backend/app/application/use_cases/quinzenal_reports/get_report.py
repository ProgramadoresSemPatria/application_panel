...
class GetReportUseCase:
    ...
    def _build_metrics_from_report(
        ...
        return ReportMetricsDTO(
            ...
            interviews_completed_fortnight=(report.interviews_completed_fortnight),
            ...
            total_initial_screenings_count=(report.total_initial_screenings_count),
        )
    ...
    async def execute(
        ...
        report_summary = ReportSummaryDTO(
            ...
            submitted_at=(submitted_report.submitted_at if submitted_report else None),
        )
        ...
        if submitted_report:
            ...
            manual_metrics = ManualMetricsDTO(
                ...
                strategic_connections_count=(submitted_report.strategic_connections_count),
